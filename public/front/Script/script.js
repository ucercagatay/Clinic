...
const slide1btn = document.getElementById("slide1-btn");
...
const slideDefault = () =>{
    ...
    slide1btn.style.backgroundColor="rgba(255, 255, 255, 0.4)";
    slide2btn.style.backgroundColor="rgba(255, 255, 255, 0.4)";
    slide3btn.style.backgroundColor="rgba(255, 255, 255, 0.4)";

}
slide1btn.onclick= ()=>{
    slideDefault();
    slide1btn.style.backgroundColor="white";
    slide1.style.display="block";
}
slide2btn.onclick= ()=>{
    slideDefault();
    slide2btn.style.backgroundColor="white";
    slide2.style.display="block";
}
slide3btn.onclick= ()=>{
    slideDefault();
    slide3btn.style.backgroundColor="white";
